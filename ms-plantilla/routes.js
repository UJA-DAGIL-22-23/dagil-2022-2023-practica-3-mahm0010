...
/**
 * Devuelve todos las tenistas que hay en la BBDD
 */
...
router.param("idTenista", (req, res, next, id) => {
    next();
});

/**
 * Devuelve los datos del tenista con el id pasado
 */
router.get("/getPorId/:idTenista", async (req, res) => {
    try {
